          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="bg-white/10 hover:bg-white/20 backdrop-blur-sm px-3 py-2 rounded-lg transition-all duration-200 text-sm font-medium border border-white/20 flex items-center gap-2"
