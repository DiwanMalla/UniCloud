...
import { useRouter } fr                    <p className="text-sm text-gray-500">Storage Used</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Subjects Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">{gation";
...
export default function FileUpload() {
  ...
  const deleteSubject = async (subjectId: string) => {
    if (!confirm("Are you sure you want to delete this subject? This action cannot be undone and will fail if there are files in this subject.")) {
      return;
    }
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">Secure University File Storage</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-8 border border-blue-100">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                  Organize your university files by subject with military-grade encryption. 
                  Upload assignments, notes, and resources safely to the cloud.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                  ...
                  <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-white/80">
                    ...
                    <p className="text-sm text-gray-600">Subject-based folders</p>
                  </div>
                  <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-white/80">
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600 mt-1">Click on a subject to view and manage files</p>
              </div>
              <button
